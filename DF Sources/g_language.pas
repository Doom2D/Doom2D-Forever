...
Const
  g_lang_default: Array [TStrings_Locale] of Array [1..3] of String = (
    ...
    ('NET SLIST RETRIEVED',            '%d servers retrieved.',
                                       '%d сервер(а, ов) найден(о).'),
    ('NET SLIST CONN',                 'Connected to master server.',
                                       'Подключились к мастерсерверу.'),
    ('NET SLIST DISC',                 'Disconnected from master server.',
                                       'Отключились от мастерсервера.'),
    ('NET SLIST LOST',                 'Lost connection with master server.',
                                       'Соединение с мастером потеряно.'),
    ('NET SLIST ERROR',                'Could not connect to master server.',
    ...
    ('CREDITS CLO 3',                  '- Everyone who helped our project',
                                       '- Всем, кто помогал нашему проекту'),
    ('CREDITS CLO 4',                  'www.doom2d.org, 2003-2014',
                                       'www.doom2d.org, 2003-2014'),
