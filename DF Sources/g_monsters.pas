...
Type
  ...
  Public
    constructor Create(MonsterType: Byte; aID: Integer);
...
// Соблюдаем ограничение Lost_Soul'ов:
  ...
  gMonsters[find_id] := TMonster.Create(MonsterType, find_id);
...
constructor TMonster.Create(MonsterType: Byte; aID: Integer);
var
  a: Integer;
  FramesID: DWORD;
  s: String;
