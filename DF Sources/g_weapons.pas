...
begin
  ...
  g_Sound_CreateWADEx('SOUND_PLAYER_CASING3', GameWAD+':SOUNDS\CASINGSTOP1');
  g_Sound_CreateWADEx('SOUND_PLAYER_CASING4', GameWAD+':SOUNDS\CASINGSTOP2');
  g_Sound_CreateWADEx('SOUND_PLAYER_SHELL3', GameWAD+':SOUNDS\SHELLSTOP1');
  g_Sound_CreateWADEx('SOUND_PLAYER_SHELL4', GameWAD+':SOUNDS\SHELLSTOP2');
...
begin
  ...
  g_Sound_Delete('SOUND_PLAYER_CASING3');
  g_Sound_Delete('SOUND_PLAYER_CASING4');
  g_Sound_Delete('SOUND_PLAYER_SHELL3');
  g_Sound_Delete('SOUND_PLAYER_SHELL4');
