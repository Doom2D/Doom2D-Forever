...
const
  ...
  PANELNAMES: array[0..11] of string =
              ('Стена', 'Фон', 'Передний план', 'Вода', 'Кислота 1', 'Кислота 2',
               'Ступень', 'Лифт вверх', 'Лифт вниз', 'Откр. дверь', 'Закр. дверь', 'Блок. мон.');
...
begin
 ...
 MainForm.lLoad.Caption := 'Чтение WAD';
 ...
 begin
  ...
  MainForm.lLoad.Caption := 'Чтение текстур';
 ...
 begin
  ...
  MainForm.lLoad.Caption := 'Чтение панелей';
 ...
 begin
  ...
  MainForm.lLoad.Caption := 'Чтение предметов';
 ...
 begin
  ...
  MainForm.lLoad.Caption := 'Чтение монстров';
 ...
 begin
  ...
  MainForm.lLoad.Caption := 'Чтение областей';
 ...
 begin
  ...
  MainForm.lLoad.Caption := 'Чтение триггеров';
...
begin
 ...
 MainForm.pbLoad.Position := 0;
 MainForm.lLoad.Caption := 'Загрузка файла карты в память';
 Application.ProcessMessages;
