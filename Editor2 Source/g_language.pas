...
Const
  g_lang_default: Array [TStrings_Locale] of Array [1..3] of String = (
    ...
    ('ARRAY PANEL LIFT DOWN',          'Lift Down',
                                       'Лифт вниз'),
    ('ARRAY PANEL BLOCKMON',           'Monster Boundry',
                                       'Блок. мон.'),
    ...
    ('ARRAY ITEM ROCKET LAUNCHER',     'Rocket Launcher',
                                       'Ракетница'),
    ('ARRAY ITEM PLASMA RIFLE',        'Plasma Gun',
                                       'Плазмаган'),
    ('ARRAY ITEM BFG',                 'BFG9000',
                                       'BFG9000'),
    ('ARRAY ITEM SUPER MINIGUN',       'Superpulemet "PWNAGER"',
                                       'Суперпулемет'),
    ...
    ('ARRAY MON ZOMBIE',               'Zombie',
                                       'Зомби'),
    ('ARRAY MON SERGEANT',             'Shotgun Guy',
                                       'Сержант'),
    ...
    ('ARRAY TR OFF',                   'Disable Trigger',
                                       'Запретить триггер'),
    ('ARRAY TR SWITCH',                'Trigger Enable/Disable',
                                       'Переключатель'),
    ('ARRAY TR SOUND',                 'Sound',
                                       'Звук'),
    ...
    ('PROP TR TEXTURE PANEL',          'Texture Panel',
                                       'Панель с текстурой'),
    ('PROP TR ACTIVATION',             'Act. Type',
                                       'Тип активации'),
    ('PROP TR KEYS',                   'Keys',
                                       'Ключи'),
    ('PROP TR D2D',                    'Like D2D',
                                       'Как в D2D'),
    ...
    ('PROP TR SOUND PAN',              'Pan',
                                       'Стерео'),
    ('PROP TR SOUND COUNT',            'Play Times',
                                       'Играть раз'),
    ...
    ('MSG WRONG ALPHA',                'Opacity must be in [0..255] interval',
    ...
    ('MSG RES NAME 64',                'Resource "%s" name length must be less than 64 chars',
    ...
    ('MSG CLEAR MAP',                  'New map',
                                       'Новая карта'),
    ('MSG CLEAR MAP PROMT',            'Clear whole map?',
                                       'Очистить всю карту?'),
    ...
    ('MENU SERV',                      'Service',
                                       'Сервис'),
    ('MENU SERV TEST',                 'Check Map...',
                                       'Проверка карты...'),
    ('MENU SERV OPT',                  'Optimize Map...',
                                       'Оптимизация карты...'),
    ('MENU SERV PREVIEW',              'Preview',
                                       'Предварительный просмотр'),
    ('MENU SERV LAUNCH',               'Run',
                                       'Тест карты в игре'),
    ...
    ('CTRL OPT LIFT',                  'Lifts',
                                       'Лифты'),
    ('CTRL OPT BLOCKMON',              'Monster Boundry',
                                       'Блок. мон.'),
    ...
    ('BTN TEXTURE EMPTY',              'Deselect all textures',
    ...
    ('TEST AREA WALL',                 'Player collides with a map, he will be stuck in the wall.',
    ...
    ('TEST MONSTER WALL',              'Monster collides with a map. It will be stuck in the wall.',
    ...
    ('OPT LIFTS',                      'Lifts Optimization...',
                                       'Оптимизация лифтов...'),
    ('OPT BLOCKMON',                   'Monster Boundries Optimization...',
    ...
    ('FILE FILTER ALL',                'Doom 2D: Forever Maps (*.wad)|*.wad|Doom 2D: Forever Ini Maps (*.ini)|*.ini|Any File (*.*)|*.*',
                                       'Карты Doom 2D: Forever (*.wad)|*.wad|Ini Карты Doom 2D: Forever (*.ini)|*.ini|Все файлы (*.*)|*.*'),
    ('FILE FILTER WAD',                'Doom 2D: Forever Maps (*.wad)|*.wad|Any File (*.*)|*.*',
