...
Const
  g_lang_default: Array [TStrings_Locale] of Array [1..3] of String = (
    ...
    ('MSG RES NAME 64',                'Resource "%s" name must be shorter than 64 chars',
    ...
    ('MSG CLEAR MAP',                  'New map',
                                       'Новая карта'),
    ('MSG CLEAR MAP PROMT',            'Clear the whole map?',
                                       'Очистить всю карту?'),
    ...
    ('CTRL ACT PLAYER CLOSE',          'Player Near',
                                       'Игрок близко'),
    ('CTRL ACT MONSTER CLOSE',         'Monster Near',
                                       'Монстр близко'),
    ...
    ('FILE FILTER ALL',                'Doom 2D: Forever Maps (*.wad)|*.wad|Doom 2D: Forever Ini Maps (*.ini)|*.ini|All Files (*.*)|*.*',
