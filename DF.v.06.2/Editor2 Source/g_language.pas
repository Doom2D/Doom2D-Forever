...
Const
  g_lang_default: Array [TStrings_Locale] of Array [1..3] of String = (
    ...
    ('ARRAY PANEL WALL',               'Wall',
                                       'Стена'),
    ('ARRAY PANEL BACK',               'Back Plane',
                                       'Фон'),
    ('ARRAY PANEL FRONT',              'Fore Plane',
                                       'Передний план'),
    ('ARRAY PANEL DOOR OPEN',          'Opened Door',
                                       'Откр. дверь'),
    ('ARRAY PANEL DOOR CLOSE',         'Closed Door',
                                       'Закр. дверь'),
    ('ARRAY PANEL STAIR',              'Stair',
                                       'Ступень'),
    ...
    ('ARRAY PANEL LIFT DOWN',          'Lift Down',
                                       'Лифт вниз'),
    ('ARRAY PANEL BLOCKMON',           'Monster Clip',
                                       'Блок. мон.'),

    ('ARRAY ITEM MEDKIT',              'Medkit',
                                       'Аптечка'),
    ('ARRAY ITEM LARGE MEDKIT',        'Large Medkit',
                                       'Большая аптечка'),
    ('ARRAY ITEM BLACK MEDKIT',        'Black Medkit',
                                       'Черная аптечка'),
    ('ARRAY ITEM GREEN ARMOR',         'Green Armor',
                                       'Зеленая броня'),
    ('ARRAY ITEM BLUE ARMOR',          'Blue Armor',
                                       'Синяя броня'),
    ('ARRAY ITEM BLUE SPHERE',         'Blue Sphere',
                                       'Шарик 100%'),
    ('ARRAY ITEM MEGASPHERE',          'Mega Sphere',
                                       'Мегасфера'),
    ('ARRAY ITEM HAZ SUIT',            'Haz Suit',
                                       'Костюм'),
    ('ARRAY ITEM OXYGEN',              'Oxygen Tank',
                                       'Акваланг'),
    ...
    ('ARRAY ITEM SHOTGUN',             'Shotgun',
                                       'Ружье'),
    ('ARRAY ITEM DB SHOTGUN',          '2 Barrel Shotgun',
                                       'Двустволка'),
    ...
    ('ARRAY ITEM BFG',                 'BFG9000',
                                       'BFG9000'),
    ('ARRAY ITEM SUPER MINIGUN',       'Super Minigun',
                                       'Суперпулемет'),
    ('ARRAY ITEM CLIP',                'Clip',
                                       'Патроны'),
    ('ARRAY ITEM AMMO BOX',            'Ammo Box',
                                       'Ящик патронов'),
    ('ARRAY ITEM 4 SHELLS',            '4 Shells',
                                       '4 гильзы'),
    ('ARRAY ITEM 25 SHELLS',           'Shell Box',
                                       '25 гильз'),
    ('ARRAY ITEM 1 ROCKET',            '1 Rocket',
                                       '1 ракета'),
    ('ARRAY ITEM ROCKET BOX',          'Rocket Box',
                                       '5 ракет'),
    ('ARRAY ITEM CELL',                'Cell Battery',
                                       'Батарейка'),
    ('ARRAY ITEM LARGE CELL',          'Large Cell Battery',
                                       'Батарея'),
    ('ARRAY ITEM BACKPACK',            'Ammo Backpack',
                                       'Рюкзак'),
    ...
    ('ARRAY MON MASTERMIND',           'Spider Mastermind',
                                       'Большой паук'),
    ('ARRAY MON ARACHNATRON',          'Big Spider',
                                       'Арахнотрон'),
    ('ARRAY MON MANCUBUS',             'Mancubus',
                                       'Манкубус'),
    ('ARRAY MON REVENANT',             'Revenant',
                                       'Скелет'),
    ('ARRAY MON ARCHVILE',             'Archvile',
                                       'Колдун'),
    ('ARRAY MON FISH',                 'Fish',
                                       'Рыба'),
    ...
    ('ARRAY TR DOOR CLOSE',            'Close Door',
                                       'Закрыть дверь'),
    ('ARRAY TR DOOR SWITCH',           'Switch Door',
                                       'Дверь'),
    ('ARRAY TR DOOR 5 SEC',            'Open Door 5 sec',
                                       'Дверь (5 сек)'),
    ('ARRAY TR TRAP CLOSE',            'Close Trap',
                                       'Закрыть ловушку'),
    ('ARRAY TR TRAP',                  'Trigger Trap',
                                       'Ловушка'),
    ...
    ('ARRAY TR LIFT DOWN',             'Lift Down',
                                       'Лифт вниз'),
    ('ARRAY TR LIFT SWITCH',           'Switch Lift',
                                       'Лифт'),
    ...
    ('ARRAY TR OFF',                   'Disable Trigger',
                                       'Выключатель'),
    ('ARRAY TR SWITCH',                'Switch Trigger',
                                       'Переключатель'),
    ...
    ('PROP PANEL TYPE',                'Panel Type',
                                       'Тип панели'),
    ('PROP PANEL ALPHA',               'Opacity',
                                       'Прозрачность'),
    ('PROP PANEL BLEND',               'Blending',
                                       'Смешивание'),
    ('PROP DM ONLY',                   'DM Only',
                                       'Только DM'),
    ('PROP ITEM FALLS',                'Can Fall',
                                       'Падает'),
    ('PROP DIRECTION',                 'Direction',
                                       'Направление'),

    ('PROP TR TYPE',                   'Trigger',
                                       'Тип триггера'),
    ('PROP TR ENABLED',                'Enabled',
                                       'Включен'),
    ('PROP TR TEXTURE PANEL',          'Texture Panel',
                                       'Панель с текстурой'),
    ('PROP TR ACTIVATION',             'Condition',
                                       'Тип активации'),
    ('PROP TR KEYS',                   'Need Keys',
                                       'Ключи'),
    ('PROP TR D2D',                    'D2d Style',
                                       'Как в D2D'),
    ...
    ('PROP TR TEXTURE ONCE',           'Once',
                                       'Один раз'),
    ('PROP TR TEXTURE ANIM ONCE',      'Anim Once',
                                       'Аним. один раз'),
    ...
    ('PROP TR MONSTER TO',             'Spawn at',
                                       'Точка появления'),
    ('PROP TR MONSTER HEALTH',         'New Health',
                                       'Здоровье'),
    ...
    ('MSG ERROR',                      'Error',
                                       'Ошибка'),
    ('MSG WRONG TEXWIDTH',             'Panel width must be multiple of its texture width (%d)',
                                       'Длина панели должна быть кратна длине текстуры (%d)'),
    ('MSG WRONG TEXHEIGHT',            'Panel height must be multiple of its texture height (%d)',
                                       'Высота панели должна быть кратна высоте текстуры (%d)'),
    ('MSG WRONG ALPHA',                'Opacity must be in [0..255]',
                                       'Прозрачность должна быть в интервале [0..255]'),
    ('MSG WRONG SIZE',                 'Width and Height must be greater than 0',
                                       'Высота и длина должны быть больше 0'),
    ('MSG WRONG XY',                   'X or Y coordinate hasn''t been set',
                                       'Не заданы координаты X и Y'),
    ('MSG TEXTURE ALREADY',            'Texture "%s" already exists',
                                       'Текстура "%s" уже существует'),
    ('MSG RES NAME 64',                'Resource "%s" name length must be less than 65 chars',
                                       'Имя ресурса "%s" должно быть <= 64 символам'),
    ...
    ('MSG EXIT PROMT',                 'Leaving so soon?',
                                       'Уже уходите?'),
    ('MSG DEL TEXTURE',                'Delete texture',
                                       'Удалить текстуру'),
    ('MSG DEL TEXTURE PROMT',          'Delete texture "%s" ?',
                                       'Удалить текстуру "%s" ?'),
    ('MSG DEL TEXTURE CANT',           'Can''t delete texture in use. Delete panels with this texture first',
                                       'Нельзя удалить текстуру пока она используется. Удалите все панели с этой текстурой'),
    ('MSG CLEAR MAP',                  'New map',
                                       'Новая карта'),
    ('MSG CLEAR MAP PROMT',            'Clear the map?',
                                       'Очистить всю карту?'),
    ('MSG DELETE MAP',                 'Delete map',
                                       'Удалить карту'),
    ('MSG DELETE MAP PROMT',           'Delete map "%s" from "%s" ?',
                                       'Удалить карту "%s" из "%s" ?'),
    ('MSG MAP DELETED',                'Map deleted',
                                       'Карта удалена'),
    ('MSG MAP DELETED PROMT',          'Map "%s" deleted',
                                       'Карта "%s" удалена'),
    ('MSG EXEC ERROR',                 'Game execution error',
                                       'Ошибка запуска'),
    ('MSG SOUND ERROR',                'Can''t play sound',
                                       'Не получается проиграть звук'),
    ...
    ('HINT PANEL LIFT',                'Choose Lift',
                                       'Выберите панель лифта'),
    ('HINT MONSTER',                   'Choose Monster',
                                       'Выберите монстра'),
    ('HINT EXT AREA',                  'Draw Area of effect',
                                       'Нарисуйте область воздействия'),
    ('HINT WIDTH',                     'Width: %d',
                                       'Длина: %d'),
    ...
    ('MENU EDIT UNDO',                 'Undo',
                                       'Отменить'),
    ('MENU EDIT COPY',                 'Copy Object',
                                       'Копировать объект'),
    ('MENU EDIT CUT',                  'Cut Object',
                                       'Вырезать объект'),
    ('MENU EDIT PASTE',                'Paste Object',
                                       'Вставить объект'),
    ...
    ('MENU SERV',                      'Service',
                                       'Сервис'),
    ('MENU SERV TEST',                 'Test Map...',
                                       'Проверка карты...'),
    ('MENU SERV OPT',                  'Map Optimization...',
                                       'Оптимизация карты...'),
    ('MENU SERV PREVIEW',              'Preview Mode',
                                       'Предварительный просмотр'),
    ('MENU SERV LAUNCH',               'Run Map in Game',
                                       'Тест карты в игре'),
    ...
    ('MENU SETS MAP',                  'Map...',
                                       'Карта...'),
    ('MENU SETS EDITOR',               'Editor...',
                                       'Редактор...'),
    ('MENU SETS LAUNCH',               'Run in Game...',
                                       'Параметры теста...'),
    ...
    ('MENU LAYER BACK',                'Background',
                                       'Фон'),
    ('MENU LAYER WALL',                'Walls',
                                       'Стены'),
    ('MENU LAYER FORE',                'Foreground',
                                       'Передний план'),
    ('MENU LAYER STAIR',               'Stairs',
                                       'Лестницы'),
    ('MENU LAYER WATER',               'Fluids',
                                       'Жидкости'),
    ('MENU LAYER ITEM',                'Items',
                                       'Предметы'),
    ('MENU LAYER MONSTER',             'Monsters',
                                       'Монстры'),
    ('MENU LAYER AREA',                'Areas',
                                       'Области'),
    ('MENU LAYER TRIGGER',             'Triggers',
                                       'Триггеры'),

    ('MENU TB NEW',                    'Clear Map',
                                       'Очистить карту'),
    ...
    ('MENU TB GRID STEP',              'Switch Grid Step',
                                       'Изменить шаг сетки'),
    ('MENU TB LAUNCH',                 'Run Map in Game',
                                       'Тест карты в игре'),
    ...
    ('CAP ADD SKY',                    'Select Sky Texture',
                                       'Выберите текстуру для неба'),
    ('CAP ADD SOUND',                  'Select Sound/Music',
                                       'Выберите звук или музыку'),
    ...
    ('CAP OPT',                        'Map Optimization',
                                       'Оптимизация карты'),
    ('CAP SETS',                       'Map Settings',
                                       'Настройки карты'),
    ('CAP LAUNCH',                     'Run Map in Game Settings',
                                       'Настройки теста карты в игре'),
    ...
    ('CTRL ACT PLAYER CLOSE',          'Player Close',
                                       'Игрок близко'),
    ('CTRL ACT MONSTER CLOSE',         'Monster Close',
                                       'Монстр близко'),
    ('CTRL ACT PLAYER PRESS',          'Player Press',
                                       'Игрок нажал'),
    ('CTRL ACT MONSTER PRESS',         'Monster Press',
                                       'Монстр нажал'),
    ('CTRL ACT SHOT',                  'Shot',
                                       'Выстрел'),
    ...
    ('CTRL OPT LIFT',                  'Lifts',
                                       'Лифты'),
    ('CTRL OPT BLOCKMON',              'Monster Clips',
                                       'Блок. мон.'),
    ...
    ('CTRL OPT DESC PANEL',            'Merges nearby panels of same type. Increases game performance.',
                                       '"Склеивает" расположенные вплотную друг к другу одинаковые панели в одну. Увеличивает производительность игры.'),
    ...
    ('CTRL LAUNCH MONSTERS',           'Enable Monsters',
                                       'Монстры в DM'),
    ('CTRL LAUNCH CLOSE',              'Close the game after exiting map',
                                       'Закрыть игру после выхода из карты'),
    ('CTRL LAUNCH OPEN',               'Select Doom 2D: Forever execute',
    ...
    ('CTRL PACK NON STD',              'Only non-Standard Resources',
    ...
    ('LAB SPECTRUM',                   'Click to turn on Spectrum',
                                       'Кликните, чтобы включить спектр'),

    ('LAB ABOUT VER',                  'Version 2.1',
                                       'Версия 2.1'),
    ...
    ('LAB SETS FOR',                   'for',
                                       'на'),
    ('LAB SETS B LEFT',                'Move Left Map Border',
                                       'Сдвинуть левую границу карты'),
    ('LAB SETS B RIGHT',               'Move Right Map Border',
                                       'Сдвинуть правую границу карты'),
    ('LAB SETS B TOP',                 'Move Top Map Border',
                                       'Сдвинуть верхнюю границу карты'),
    ('LAB SETS B BOTTOM',              'Move Bottom Map Border',
    ...
    ('LAB ES MINIMAP',                 'MiniMap Scale:',
                                       'Масштаб мини-карты:'),
    ('LAB ES RECENT',                  'Recent Opened Maps to Remember:',
    ...
    ('LAB PACK SAVE TO',               'Save to:',
                                       'Сохранить в:'),
    ('LAB PACK MAP NAME',              'Resource Name (Map):',
                                       'Имя ресурса (карты):'),
    ...
    ('BTN TEXTURE EMPTY',              'Clear texture selection',
                                       'Убрать выбор текстуры'),
    ...
    ('TEST AREA WALL',                 'Area collides with Map. Player who spawns here will be stuck in wall.',
                                       'Область пересекается с картой. Если в этой точке появится игрок, то он застрянет в стене и не сможет двигаться.'),
    ...
    ('TEST SPAWNS',                    'It''s no need in several spawn points for player on the map. Only one will be used.',
                                       'Зачем несколько точек появления? Игрок будет появляться на одной из этих точек.'),
    ...
    ('TEST MONSTER WALL',              'Monster collides with Map. He will be stuck in wall.',
                                       'Монстр пересекается с картой. Он застрянет в стене и не сможет двигаться'),
    ('TEST MONSTER WALL STR',          'Monster #%d collides with Map (%d:%d)',
                                       'Монстр #%d пересекается с картой (%d:%d)'),

    ('OPT NO TEXTURES',                'Texture list is empty',
                                       'Список текстур пустой'),
    ...
    ('OPT BACKS',                      'Background Optimization...',
                                       'Оптимизация заднего плана...'),
    ('OPT STAIRS',                     'Stairs Optimization...',
    ...
    ('OPT LIFTS',                      'Lifts Optimization...',
                                       'Оптимизация лифтов...'),
    ('OPT BLOCKMON',                   'Monster Clips Optimization...',
                                       'Оптимизация Блок. мон....'),
    ...
    ('WAD SPECIAL MAP',                '<MAP>',
                                       '<КАРТА>'),
    ('WAD SPECIAL TEXS',               '<SPECIAL TEXTURES>',
                                       '<СПЕЦТЕКСТУРЫ>'),

    ('FILE FILTER',                    'Doom 2D: Forever Maps (*.wad)|*.wad|Doom 2D: Forever Ini Maps (*.ini)|*.ini|Any File (*.*)|*.*',
                                       'Карты Doom 2D: Forever (*.wad)|*.wad|Ini Карты Doom 2D: Forever (*.ini)|*.ini|Все файлы (*.*)|*.*'),
