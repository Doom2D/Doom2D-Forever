...
{$IFDEF DARWIN}
  {$LINKLIB libSDL_mixer-1.2.0.dylib}
...
function Mix_Init( flags : cint ) : cint;
cdecl; external {$IFDEF __GPC__}name 'Mix_Init'{$ELSE} SDL_MixerLibName{$ENDIF __GPC__};
{$EXTERNALSYM Mix_Init}

{ Unloads libraries loaded with Mix_Init }
procedure Mix_Quit();
cdecl; external {$IFDEF __GPC__}name 'Mix_Quit'{$ELSE} SDL_MixerLibName{$ENDIF __GPC__};
{$EXTERNALSYM Mix_Quit}
...
function Mix_QuerySpec( frequency : Pinteger; format : PUint16; channels : Pinteger ) : integer;
...
function Mix_GetNumChunkDecoders() : cint;
cdecl; external {$IFDEF __GPC__}name 'Mix_GetNumChunkDecoders'{$ELSE} SDL_MixerLibName{$ENDIF __GPC__};
{$EXTERNALSYM Mix_GetNumChunkDecoders}

function Mix_GetChunkDecoder( index: cint ) : pchar;
cdecl; external {$IFDEF __GPC__}name 'Mix_GetChunkDecoder'{$ELSE} SDL_MixerLibName{$ENDIF __GPC__};
{$EXTERNALSYM Mix_GetChunkDecoder}

function Mix_GetNumMusicDecoders() : cint;
cdecl; external {$IFDEF __GPC__}name 'Mix_GetNumMusicDecoders'{$ELSE} SDL_MixerLibName{$ENDIF __GPC__};
{$EXTERNALSYM Mix_GetNumMusicDecoders}

function Mix_GetMusicDecoder( index: cint ) : pchar;
cdecl; external {$IFDEF __GPC__}name 'Mix_GetMusicDecoder'{$ELSE} SDL_MixerLibName{$ENDIF __GPC__};
{$EXTERNALSYM Mix_GetMusicDecoder}

{ Find out the music format of a mixer music, or the currently playing
   music, if 'music' is NULL.}
function Mix_GetMusicType(constref music : TMix_Music ) : TMix_MusicType;
