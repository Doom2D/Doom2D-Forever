...
Interface
  ...
  resourcestring
    ...
    MsgMenuLayerMonsters = 'Monsters';
    MsgMenuLayerAreas = 'Areas';
    MsgMenuLayerItems = 'Items';
    MsgMenuLayerTriggers = 'Triggers';
...
// Главная форма:
  ...
  // View menu:
    ...
    miLayerMonsters.Caption := MsgMenuLayerMonsters;
    miLayerAreas.Caption := MsgMenuLayerAreas;
    miLayerItems.Caption := MsgMenuLayerItems;
    miLayerTriggers.Caption := MsgMenuLayerTriggers;
