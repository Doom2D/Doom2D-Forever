...
const
  ...
  JOY0_DPAD_UP = JOYK_BEG + 0*e_MaxJoyBtns + 11;
  JOY1_DPAD_UP = JOYK_BEG + 1*e_MaxJoyBtns + 11;
  JOY2_DPAD_UP = JOYK_BEG + 2*e_MaxJoyBtns + 11;
  JOY3_DPAD_UP = JOYK_BEG + 3*e_MaxJoyBtns + 11;
  JOY0_DPAD_DOWN = JOYK_BEG + 0*e_MaxJoyBtns + 12;
  JOY1_DPAD_DOWN = JOYK_BEG + 1*e_MaxJoyBtns + 12;
  JOY2_DPAD_DOWN = JOYK_BEG + 2*e_MaxJoyBtns + 12;
  JOY3_DPAD_DOWN = JOYK_BEG + 3*e_MaxJoyBtns + 12;
  JOY0_DPAD_LEFT = JOYK_BEG + 0*e_MaxJoyBtns + 13;
  JOY1_DPAD_LEFT = JOYK_BEG + 1*e_MaxJoyBtns + 13;
  JOY2_DPAD_LEFT = JOYK_BEG + 2*e_MaxJoyBtns + 13;
  JOY3_DPAD_LEFT = JOYK_BEG + 3*e_MaxJoyBtns + 13;
  JOY0_DPAD_RIGHT = JOYK_BEG + 0*e_MaxJoyBtns + 14;
  JOY1_DPAD_RIGHT = JOYK_BEG + 1*e_MaxJoyBtns + 14;
  JOY2_DPAD_RIGHT = JOYK_BEG + 2*e_MaxJoyBtns + 14;
  JOY3_DPAD_RIGHT = JOYK_BEG + 3*e_MaxJoyBtns + 14;
  JOY0_AXIS_LEFT = JOYA_BEG + 0*e_MaxJoyAxes*2 + 0;
  JOY1_AXIS_LEFT = JOYA_BEG + 1*e_MaxJoyAxes*2 + 0;
  JOY2_AXIS_LEFT = JOYA_BEG + 2*e_MaxJoyAxes*2 + 0;
  JOY3_AXIS_LEFT = JOYA_BEG + 3*e_MaxJoyAxes*2 + 0;
  JOY0_AXIS_RIGHT = JOYA_BEG + 0*e_MaxJoyAxes*2 + 1;
  JOY1_AXIS_RIGHT = JOYA_BEG + 1*e_MaxJoyAxes*2 + 1;
  JOY2_AXIS_RIGHT = JOYA_BEG + 2*e_MaxJoyAxes*2 + 1;
  JOY3_AXIS_RIGHT = JOYA_BEG + 3*e_MaxJoyAxes*2 + 1;
  JOY0_AXIS_UP = JOYA_BEG + 0*e_MaxJoyAxes*2 + 2;
  JOY1_AXIS_UP = JOYA_BEG + 1*e_MaxJoyAxes*2 + 2;
  JOY2_AXIS_UP = JOYA_BEG + 2*e_MaxJoyAxes*2 + 2;
  JOY3_AXIS_UP = JOYA_BEG + 3*e_MaxJoyAxes*2 + 2;
  JOY0_AXIS_DOWN = JOYA_BEG + 0*e_MaxJoyAxes*2 + 3;
  JOY1_AXIS_DOWN = JOYA_BEG + 1*e_MaxJoyAxes*2 + 3;
  JOY2_AXIS_DOWN = JOYA_BEG + 2*e_MaxJoyAxes*2 + 3;
  JOY3_AXIS_DOWN = JOYA_BEG + 3*e_MaxJoyAxes*2 + 3;
