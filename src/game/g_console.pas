...
const
  defaultConfigScript = {$IFNDEF HEADLESS} 'dfconfig.cfg' {$ELSE} 'dfserver.cfg' {$ENDIF};
...
var
  ...
  gJustChatted: Boolean;  // чтобы админ в интере чатясь не проматывал статистику
...
const
  ...
  configComment = 'generated by '+GAME_NAME+', do not modify';
...
var
  tcomplist: array of AnsiString;
  tcompidx: array of Integer;
