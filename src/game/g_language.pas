...
const
  g_lang_default: Array [TStrings_Locale] of Array [1..3] of String = (
    ...
    ('MENU ITEM RESPAWN RANDOM',       'Additive time for item timer:',
                                       'Дополнительный число к таймеру предметов:'),
