...
const
  g_lang_default: Array [TStrings_Locale] of Array [1..3] of String = (
    ...
    ('MENU SELECT ITEM RESPAWN',       'Items Respawn Settings',
                                       'Настроить респаун предметов'),
    ('MENU ITEM RESPAWN',              'Items Respawn Settings',
                                       'Настройка респауна предметов'),
    ...
    ('MENU ITEM RESPAWN RANDOM',       'Additive time for item timer:',
                                       'Числитель для таймера предметов:'),
    ...
    ('MSG RULEZ RANDOM ON',            'Random respawn for powerups on',
                                       'Рандомный респавн для поверапов включён'),
    ('MSG RULEZ RANDOM OFF',           'Random respawn for powerups off',
                                       'Рандомный респавн для поверапов выключен'),
    ('MSG ITEM ALL RANDOM ON',         'Random respawn for all items on',
                                       'Рандомный респавн для всех предметов включён'),
    ('MSG ITEM ALL RANDOM OFF',        'Random respawn for all items off',
                                       'Рандомный респавн для всех предметов выключен'),
    ('MSG ITEM HELP RANDOM ON',        'Random respawn for life-saving items on',
                                       'Рандомный респавн для вспомогательных предметов включён'),
    ('MSG ITEM HELP RANDOM OFF',       'Random respawn for life-saving items off',
                                       'Рандомный респавн для вспомогательных предметов выключен'),
    ('MSG ITEM AMMO RANDOM ON',        'Random respawn for ammo on',
                                       'Рандомный респавн для боеприпасов включён'),
    ('MSG ITEM AMMO RANDOM OFF',       'Random respawn for ammo off',
                                       'Рандомный респавн для боеприпасов выключен'),
    ('MSG ITEM WEAPON RANDOM ON',      'Random respawn for weapons on',
                                       'Рандомный респавн для оружия включён'),
    ('MSG ITEM WEAPON RANDOM OFF',     'Random respawn for weapons off',
                                       'Рандомный респавн для оружия выключен'),
