...
type
  TStrings_Locale = (
    ...
    I_MENU_ENABLE_EXITS,
    I_MENU_WEAPONS_STAY,
    I_MENU_ENABLE_TEAM_ABSORB_ATTACKS,
    ...
    I_MENU_PLAYER_1,
    I_MENU_PLAYER_2,
    I_MENU_PLAYER_1_CONTROLS,
    I_MENU_PLAYER_2_CONTROLS,
    ...
    I_MENU_KNUCKLES_ALLOW,
    I_MENU_KNUCKLES_ALLOW_BERSERK,
    I_MENU_KNUCKLES_ALLOW_ALWAYS,
    I_MENU_WEAPON_PRIORITY_PLAYER_1,
    I_MENU_WEAPON_PRIORITY_PLAYER_2,

    I_MENU_MODEL_INFO,
    I_MENU_MODEL_SHOW_TEAM_LOOK,
    I_MENU_MODEL_HIDE_TEAM_LOOK,
    ...
    I_MENU_END_GAME_PROMPT,
    I_MENU_RESTART_GAME_PROMPT,
    I_MENU_EXIT_PROMPT,
    I_MENU_SET_DEFAULT_PROMPT,
    I_MENU_LOAD_SAVED_PROMPT,
    ...
    I_MSG_TEAM_HIT_PROJECTILE_ON,
    I_MSG_TEAM_HIT_PROJECTILE_OFF,
    I_MSG_TEAM_HIT_TRACE_ON,
    I_MSG_TEAM_HIT_TRACE_OFF,
    I_MSG_TEAM_ABSORB_ATTACKS_ON,
    I_MSG_TEAM_ABSORB_ATTACKS_OFF,
    I_MSG_WEAPONSTAY_ON,
...
const
  g_lang_default: Array [TStrings_Locale] of Array [1..3] of String = (
    ...
    ('MENU SELECT ITEM RESPAWN',       'Items Respawn Settings',
                                       'Настроить возмещение предметов'),
    ('MENU ITEM RESPAWN',              'Items Respawn Settings',
                                       'Настройки возмещения предметов'),
    ('MENU VIDEO OPTIONS',             'Video',
                                       'ВИДЕО'),
    ('MENU SOUND OPTIONS',             'Sound',
                                       'ЗВУК'),
    ('MENU SAVED OPTIONS',             'Cancel',
                                       'ОТМЕНИТЬ'),
    ('MENU DEFAULT OPTIONS',           'Reset',
                                       'СБРОСИТЬ'),
    ...
    ('MENU MAX LIVES',                 'Lives:',
                                       'Жизни:'),
    ('MENU FRIENDLY FIRE',             'Friendly Fire:',
                                       'Урон от своих:'),
    ...
    ('MENU ITEM RESPAWN TIME',         'Item respawn time:',
                                       'Время отсутствия предмета:'),
    ('MENU ITEM RESPAWN RANDOM',       'Additive time for item timer:',
                                       'Разброс отсчёта для предметов:'),
    ...
    ('MENU PLAYER 2',                  'Player 2',
                                       'Второй игрок'),
    ('MENU PLAYER 1 CONTROLS',         'Player 1 Controls',
                                       'Первый игрок, основное'),
    ('MENU PLAYER 2 CONTROLS',         'Player 2 Controls',
                                       'Второй игрок, основное'),
    ...
    ('MENU GAME MESSAGES',             'Show messages:',
                                       'Выводить сообщения:'),
    ('MENU GAME SWAP PLAYERS',         'Swap player screens:',
                                       'Второй игрок сверху:'),
    ...
    ('MENU SOUND SOUND LEVEL',         'Sound volume:',
                                       'Громкость звука:'),
    ('MENU SOUND TAUNT LEVEL',         'Chat taunts volume:',
                                       'Громкость фраз в чате:'),
    ...
    ('MENU WEAPON',                    'Weapon preferences',
                                       'Настройки смены оружия'),
    ('MENU WEAPON SWITCH',             'Switch on pickup',
                                       'Менять при взятии'),
    ('MENU WEAPON SWITCH LINEAR',      'Always',
                                       'Всегда'),
    ('MENU WEAPON SWITCH PREFERENCE',  'If prioritized',
                                       'Если новое лучше'),
    ('MENU WEAPON SWITCH PRIORITY',    'Specify priorities',
                                       'Назначить предпочтения'),
    ('MENU WEAPON ALLOW EMPTY',        'Allow empty',
                                       'Выбирать пустое'),
    ('MENU KNUCKLES ALLOW',            'Skip knuckleduster',
                                       'Пропускать кастет'),
    ('MENU KNUCKLES ALLOW BERSERK',    'If no berserk',
                                       'Если без берсерка'),
    ('MENU KNUCKLES ALLOW ALWAYS',     'Never',
                                       'Никогда'),
    ('MENU WEAPON PRIORITY PLAYER 1',  'Player 1 priorities',
                                       'Предпочтения игрока 1'),
    ('MENU WEAPON PRIORITY PLAYER 2',  'Player 2 priorities',
                                       'Предпочтения игрока 2'),
    ('MENU MODEL INFO',                'About this model',
                                       'Сведения о модели'),
    ('MENU MODEL SHOW TEAM LOOK',      'Show team look',
                                       'Показать командный облик'),
    ('MENU MODEL HIDE TEAM LOOK',      'Hide team look',
                                       'Скрыть командный облик'),
    ('MENU MODEL ANIMATION',           'Change animation',
                                       'Сменить анимацию'),
    ('MENU MODEL CHANGE WEAPON',       'Change weapon',
                                       'Сменить оружие'),
    ('MENU MODEL ROTATE',              'Flip model view',
                                       'Развернуть модель'),
    ...
    ('MENU END GAME PROMPT',           'Do you want to end the game?',
    ...
    ('NET MSG PORTS',                  'Make sure that hoster has forwarded the ports %d and %d on their router or modem.',
                                       'Уточните у создателя сервера, проброшены ли порты %d и %d на его роутере или модеме.'),
    ...
    ('MESSAGE VOTE INPROGRESS',        #21'A vote is already in progress for '#18'"%s"'#21'.',
                                       #21'Уже идёт голосование за команду '#18'"%s"'#21'.'),
    ('MESSAGE VOTE STARTED',           '%s '#21'called a vote for '#18'"%s"'#21'.'#10'%d '#21'votes are required.',
                                       '%s '#21'начал голосование за команду '#18'"%s"'#21'.'#10#21'Для выполнения команды требуется голосов: '#2'%d'#21'.'),
    ('MESSAGE VOTE PASSED',            #21'Vote passed. Executing '#18'"%s" '#21'in 5 seconds.',
                                       #21'Голосование прошло успешно. Команда '#18'"%s" '#21'будет выполнена через 5 секунд.'),
    ('MESSAGE VOTE FAILED',            #21'Vote failed: not enough people voted.',
                                       #21'Голосование провалилось: недостаточно голосов "за".'),
    ('MESSAGE VOTE VOTE',              '%s '#21'votes '#18'"yes" '#21'(%d/%d votes total).',
                                       '%s '#21'голосует '#18'"за" '#21'(%d/%d голосов всего).'),
    ('MESSAGE VOTE REVOKED',           '%s '#21'revokes his vote (%d/%d votes total).',
                                       '%s '#21'отозвал свой голос (%d/%d голосов всего).'),
    ...
    ('CREDITS CLO 3',                  '- everyone who helped and supported us',
                                       '- всех, кто поддерживал нас и помогал'),
    ('CREDITS CLO 4',                  'www.doom2d.org, 2003-%u',
                                       'www.doom2d.org, 2003-%u'),
    ...
    ('MSG FRIENDLY FIRE OFF',          'Friendly Fire disabled',
                                       'Урона от своих нет'),
    ('MSG TEAM HIT PROJECTILE ON',     'Projectile tracing disabled',
                                       'Снаряды будут попадать по союзникам'),
    ('MSG TEAM HIT PROJECTILE OFF',    'Projectile tracing enabled',
                                       'Снаряды будут проходить сквозь союзников'),
    ('MSG TEAM HIT TRACE ON',          'Hit tracing disabled',
                                       'Пули будут попадать по союзникам'),
    ('MSG TEAM HIT TRACE OFF',         'Hit tracing enabled',
                                       'Пули будут проходить сквозь союзников'),
    ('MSG TEAM ABSORB ATTACKS ON',     'Damage absorption by teammates enabled',
                                       'Союзники будут получать часть урона'),
    ('MSG TEAM ABSORB ATTACKS OFF',    'Damage absorption by teammates disabled',
    ...
    ('MSG DMKEYS ON',                  'Spawning with all keys in DM enabled',
                                       'Возврат в бой со всеми ключами в DM включён'),
    ('MSG DMKEYS OFF',                 'Spawning with all keys in DM disabled',
                                       'Возврат в бой со всеми ключами в DM выключен'),
    ...
    ('MSG SPAWNINVUL',                 'Spawn invulnerability time: %d sec*',
                                       'Неуязвимость после возврата в бой: %d сек*'),
