...
begin
 ...
 begin
  Add(#13#10+'Всего текстур: '+#9+IntToStr(c));
  Add('Удалено текстур: '+#9+IntToStr(c-MainForm.lbTextureList.Count));
 end;
end;
...
begin
 ...
 begin
  ...
  mOptimizationResult.Lines.Add('Оптимизировано панелей: '+IntToStr(count)+#13#10);
 end;
 ...
 begin
  mOptimizationResult.Lines.Add('Оптимизация лифтов...');
 ...
 begin
  mOptimizationResult.Lines.Add('Оптимизация Блок. мон....');
 ...
 mOptimizationResult.Lines.Add('Всего панелей: '+IntToStr(panelcount1));
 mOptimizationResult.Lines.Add('Панелей после оптимизации: '+IntToStr(panelcount2));
 mOptimizationResult.Lines.Add('Оптимизировано панелей: '+IntToStr(panelcount1-panelcount2));
end;
