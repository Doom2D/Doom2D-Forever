...
const
  KEYTABLE: array[0..255] of string = (
    ...
    'D', 'F', 'G', 'H', 'J', 'K', 'L', ';',  // 32
    '', '', 'LShift', '\', 'Z', 'X', 'C', 'V',  // 40
    'B', 'N', 'M', ',', '.', '/', 'RShift', 'Gray *',  // 48
    'LAlt', 'Space', 'CapsLock', 'F1', 'F2', 'F3', 'F4', 'F5',  // 56
    'F6', 'F7', 'F8', 'F9', 'F10', '', 'Scroll Lock', 'Gray 7',  // 64
    'Gray 8', 'Gray 9', 'Gray -', 'Gray 4', 'Gray 5', 'Gray 6', 'Gray +', 'Gray 1',  // 72
    'Gray 2', 'Gray 3', 'Gray 0', 'Gray .', '', '', '', 'F11',  // 80
    'F12', '', '', '', '', '', '', '',  // 88
    '', '', '', '', '', '', '', '',  // 96
    '', '', '', '', '', '', '', 'Gray /',  // 104
    '', '', '', '', '', '', '', '',  // 112
